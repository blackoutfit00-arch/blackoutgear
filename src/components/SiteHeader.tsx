...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/5 bg-[#171717]/95 text-[#ffffff] shadow-[0_10px_30px_rgba(0,0,0,0.18)] backdrop-blur">
      <div className="relative mx-auto flex h-[86px] max-w-[1500px] items-center justify-between px-7 sm:h-[104px] sm:px-10">
        <div className="flex items-center gap-7">
          ...
          <form onSubmit={handleSearch} className="flex items-center gap-2">
            ...
            <input
              ...
              placeholder="Search"
              aria-label="Search products"
              className="hidden w-28 bg-transparent text-xs uppercase tracking-[0.18em] outline-none placeholder:text-[#ffffff]/55 md:block"
            />
          </form>
        </div>
        ...
        <Link
          to="/"
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-display text-[44px] font-semibold leading-none tracking-[0.08em] text-[#ffffff] sm:text-[64px]"
