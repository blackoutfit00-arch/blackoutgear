          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g. Block 1234, House 5"
              />
            </div>
            <div>
              <label className="mb-1.5 block text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-3 rounded-lg border-2 border-accent bg-accent/10 p-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Transfer details are sent when you confirm your order via WhatsApp
              </p>
            </div>
          </div>
        </SectionCard>
        ...
        <DialogContent className="max-w-md border-border bg-card">
          ...
          <div className="max-h-[45vh] space-y-3 overflow-y-auto text-sm">
            ...
            <div className="space-y-1 border-t border-border pt-3">
              ...
              <p>
                <span className="text-muted-foreground">Phone: </span>+973 {phone.trim()}
              </p>
              <p>
              ...
              <p>
                <span className="text-muted-foreground">Payment: </span>BenefitPay
              </p>
              {notes.trim() && (
                <p>
          ...
          <DialogFooter className="flex-row gap-2 sm:justify-end">
            <Button
              variant="outline"
              className="label-caps flex-1 sm:flex-none"
