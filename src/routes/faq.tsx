    ...
    <PolicyPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: <p>التوصيل داخل البحرين خلال 24 إلى 48 ساعة من تأكيد الطلب. التوصيل حالياً مجاني على جميع الطلبات.</p>,
        },
        {
          number: 4,
          ...
          body: (
            <p>
              حالياً الدفع عند الاستلام (Cash on Delivery). فيه خطة لإضافة الدفع الإلكتروني قريباً، وبنحدّث هذي الصفحة
              فور تفعيله.
            </p>
          ),
        },
