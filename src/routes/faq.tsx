...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "إجابات عن أكثر الأسئلة تكراراً حول اختيار النظارة المناسبة والتوصيل والدفع وطريقة الطلب." },
    ],
  }),
  component: FaqPage,
});
    ...
    <PolicyPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: (
            <p>
              نوضح مقاس الإطار (عرض الإطار وطول الذراع) ضمن صور كل منتج لمساعدتك تختار القياس الأنسب لوجهك. لو محتاج
              مساعدة زيادة في اختيار الإطار أو اللون المناسب، تواصل معنا على{" "}
