      ...
      sections={[
        {
          ...
          body: (
            <p>
              التوصيل خلال 8 إلى 15 يوم من تأكيد الطلب. يرجى معاينة المنتج قبل الاستلام النهائي.
            </p>
          ),
        },
        {
        ...
        },
        {
          ...
          body: (
            <p>
              لا يوجد استبدال للمنتجات بعد إتمام الطلب. يرجى التأكد من مقاس الإطار ولون النظارة ونوع
              العدسة بعناية قبل تأكيد الطلب، بالرجوع لتفاصيل كل منتج.
            </p>
          ),
        },
        {
