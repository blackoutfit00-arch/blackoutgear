  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Blackout Gear — Gym Apparel & Lifting Gear in Bahrain" },
      {
        ...
        content:
          "Oversized tees, jerseys, compression tops and lifting straps. Order on WhatsApp, delivered in Bahrain.",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 text-center sm:py-28">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm text-neutral-200 sm:text-base">
            {STORE_TAGLINE}
          </p>
        </div>
      </section>
